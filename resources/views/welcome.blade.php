...
<!-- Mirrored from landmart.netlify.app/html/ltr/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 22:04:23 GMT -->
<!-- Added by HTTrack -->
    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container container_large">
            <a class='navbar-brand' href='index.html'>
                <img src="assets/images/logo_1.png" alt="FaxEstate" class="img-fluid">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Property <i class="far fa-angle-down"></i></a>
                        <ul class="droap_menu">
                            <li><a href='property_grid_view.html'>Property grid view</a></li>
                            <li><a href='property_list_view.html'>Property list view</a></li>
                            <li><a href='property_left_sidebar.html'>Property left sidebar</a></li>
                            <li><a href='property_right_sidebar.html'>Property right sidebar</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="droap_menu">
                            ...
                            <li><a href='agencies_details.html'>Agencies Details</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="droap_menu">
                            ...
                            <li><a href='blog_details.html'>blog detals</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="menu_right d-flex align-items-center">
                    <li>
                        <a class='user_icon' href='dashboard.html'>
                            <span> <img src="assets/images/user_icon_1.png" alt="user" class="img-fluid w-100">
                            </span>
                            Profile
                        </a>
                    </li>
    ...
    <div class="menu_offcanvas offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
        ...
        <div class="offcanvas-body">
            <a class='offcanvas_logo' href='index.html'>
                <img src="assets/images/logo_1.png" alt="FaxEstate" class="img-fluid w-100">
            </a>
            ...
            <div class="offcanvas_blog">
                ...
                <ul>
                    <li>
                        <div class="img">
                            <img src="assets/images/offcanvas_img_3.jpg" alt="blog" class="img-fluid w-100">
                        </div>
                        <div class="text">
                    ...
                    <li>
                        <div class="img">
                            <img src="assets/images/offcanvas_img_1.jpg" alt="blog" class="img-fluid w-100">
                        </div>
                        <div class="text">
                            <p><i class="far fa-clock"></i> 10 Dec 2024</p>
                    ...
                    <li>
                        <div class="img">
                            <img src="assets/images/offcanvas_img_2.jpg" alt="blog" class="img-fluid w-100">
                        </div>
                        <div class="text">
                            <p><i class="far fa-clock"></i> 10 Dec 2024</p>
            ...
            <div class="offcanvas_contact">
                ...
                <a class="call" href="callto:40276328246">+(402) 763 282 46</a>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="adv_search_icon adv_search_icon_1"><i
                                                class="far fa-ellipsis-v"></i>
                                        </div>
                                        <div class="adv_search_area">
                                            <div class="adv_search_close adv_search_close_1"><i
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="adv_search_area">
                                            <div class="adv_search_close adv_search_close_2"><i
                                                    class="fal fa-times"></i></div>
                                            <h3>aminities</h3>
                                            <div class="row">
                                                <div class="col-xl-2 col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="adv_search_area">
                                            <div class="adv_search_close adv_search_close_3"><i
                                                    class="fal fa-times"></i></div>
                                            <h3>aminities</h3>
                                            <div class="row">
                                                <div class="col-xl-2 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-5 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
                    <div class="about_text">
                        ...
                        <a class='common_btn' href='about_us.html'>More Details</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-3 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_destination">
                        ...
                        <div class="destination_address">
                            <a href='property_grid_view.html'><i class="far fa-arrow-right"></i></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="text-center mt_50 wow fadeInUp" data-wow-duration="1.5s">
                    <a class='common_btn' href='property_grid_view.html'>Browse More Properties</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row wow fadeInUp" data-wow-duration="1.5s">
                <div class="col-xl-12">
                    <div class="find_state_text">
                        <h2>Residential</h2>
                        <a href='property_details.html'>Discover The Project<i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_blog">
                        <a class='blog_img' href='blog_details.html'>
                        ...
                        <div class="blog_text">
                            ...
                            <a class='item_title' href='blog_details.html'>How to stage your home for a quick
                                sale.</a>
                            <a class='read_btn' href='blog_details.html'>Read More<i class="fas fa-arrow-right"
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_blog">
                        <a class='blog_img' href='blog_details.html'>
                            <img src="assets/images/blog_2.jpg" alt="img" class="img-fluid w-100">
                        </a>
                        <div class="blog_text">
                            <ul class="d-flex flex-wrap">
                                <li>
                            ...
                            <a class='item_title' href='blog_details.html'>Luxury top-floor properties available for
                                purchase.</a>
                            <a class='read_btn' href='blog_details.html'>Read More<i class="fas fa-arrow-right"
                                    aria-hidden="true"></i></a>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_blog">
                        <a class='blog_img' href='blog_details.html'>
                            <img src="assets/images/blog_3.jpg" alt="img" class="img-fluid w-100">
                        </a>
                        <div class="blog_text">
                            <ul class="d-flex flex-wrap">
                                <li>
                            ...
                            <a class='item_title' href='blog_details.html'>Skills that you can learn the Real Estate
                                Market.</a>
                            <a class='read_btn' href='blog_details.html'>Read More<i class="fas fa-arrow-right"
                                    aria-hidden="true"></i></a>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_discover">
                        ...
                        <a class='item_title' href='property_left_sidebar.html'>Search your Location</a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_discover">
                        ...
                        <a class='item_title' href='property_left_sidebar.html'>Check out The Residence</a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_discover">
                        ...
                        <a class='item_title' href='property_left_sidebar.html'>Obtain your Perfect House</a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_discover">
                        ...
                        <a class='item_title' href='property_left_sidebar.html'>Delight in your Residence</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12">
                    <div class="marquee_animi">
                        <ul class="single_partner">
                            <li><a href='agencies_details.html'><img src="assets/images/partner_1.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_10.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_3.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_4.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_5.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_6.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_7.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_8.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_9.png"
                                        alt="img" class="img-fluid w-100"></a>
                            </li>
                            <li><a href='agencies_details.html'><img src="assets/images/partner_10.png"
                                        alt="img" class="img-fluid w-100"></a>
                            ...
                            <div class="col-xl-3 col-sm-6 col-md-4 wow fadeInLeft" data-wow-duration="1s">
                                <div class="footer_link">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href='dashboard_wishlist.html'>Wishlist</a></li>
                                        <li><a href='dashboard_profile.html'>Change Password</a></li>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="copyright_area d-flex flex-wrap justify-content-between">
                            <p>© 2024 FaxEstate All Rights Reserved by site</p>
                            <ul class="d-flex flex-wrap">
                                <li><a href='privacy_policy.html'>Privacy Policy </a></li>
                                <li><a href='terms_condition.html'>Term of Service</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from landmart.netlify.app/html/ltr/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Jun 2025 22:05:42 GMT -->
